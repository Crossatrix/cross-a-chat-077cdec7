...
import { MOD_TAB_ICON_NAMES } from "@/utils/mods";
...
[event: openedsettings; run{UI/panel.html}]`}</pre>
  ...
  { "id": "0b6c9a1e-7f3d-4c2a-8e9b-1a2b3c4d5e6f", "name": "Stats", "ui": "UI/stats.html", "icon": "BarChart3" }
              ...
              <ul className="list-disc pl-5 text-xs space-y-1">
                ...
                <li><code>icon</code> — optional; one of the names below. Falls back to a generic package
                  icon if omitted or not recognized</li>
              </ul>
              <p className="text-xs font-mono break-words mt-1">{MOD_TAB_ICON_NAMES.join(", ")}</p>
              <p className="mt-2">
