...
import { ArrowLeft, Upload, Shield, UsersRound, X, EyeOff, Play, Trash2, Ban, Crown, FlaskConical, Palette, LayoutDashboard, LifeBuoy, RefreshCw } from "lucide-react";
import { clearAllCaches } from "@/utils/localCache";
...
const Settings = () => {
  ...
  const handleToggleBlockCategory = async (category: string) => {
    ...
    if (blockedCategories.includes(category)) {
      ...
      emitModEvent("changesetting", { setting: "blocked_categories", category, value: false });
    } else {
      const { error } = await supabase
        .from("blocked_categories" as any)
      ...
      emitModEvent("changesetting", { setting: "blocked_categories", category, value: true });
    }
  };
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <ModImg src={proBadgeIcon} alt="Pro" className="h-8 w-8" />
                Cross Chat Pro
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
              {isPro ? (
                <div className="p-4 rounded-lg bg-primary/10 border border-primary/20 space-y-2">
                  <div className="flex items-center gap-2">
                    <ModImg src={proBadgeIcon} alt="Pro" className="h-6 w-6" />
