...
const Store = () => {
  ...
  const handlePurchasePro = async () => {
    ...
    if (result.success) { setIsPro(true); await refreshBalance(); }
    setPurchasing(null);
  };
  ...
  const handlePurchaseCreatorPro = async () => {
    ...
    toast(result.message);
    if (result.success) { setIsCreatorPro(true); await refreshBalance(); }
    setPurchasing(null);
  };
    ...
    <div className="min-h-screen bg-background p-4 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="ml-auto flex items-center gap-1 bg-accent/50 px-3 py-1.5 rounded-full">
          <img src={croinIcon} alt="Croins" className="w-5 h-5" />
          ...
          <Card className="border-primary/30">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                <img src={proBadgeIcon} alt="Pro" className="w-6 h-6" />
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1">
                  <img src={croinIcon} alt="" className="w-4 h-4" />
                      ...
                      <div className="flex items-center gap-2">
                        {req.price > 0 && (
                          <span className="flex items-center gap-1">
                            <img src={croinIcon} alt="" className="w-3 h-3" />{req.price}
                          </span>
                        )}
