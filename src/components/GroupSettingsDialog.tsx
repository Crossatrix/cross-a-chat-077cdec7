...
export const GroupSettingsDialog = ({
  ...
  const handleAddMember = async () => {
    ...
    try {
      ...
      if (result) {
        ...
        emitModEvent("joingroup", { conversationId, userId: profile.id });
        setUsernameSearch("");
  ...
  const handleChangeRole = async (userId: string, newRole: GroupRole) => {
    try {
      ...
      if (result) {
        ...
        emitModEvent("changegrouprole", { conversationId, userId, newRole });
        fetchMembers();
      } else {
  ...
  const handleLeaveGroup = async () => {
    try {
      ...
      if (result) {
        emitModEvent("leavegroup", { conversationId });
